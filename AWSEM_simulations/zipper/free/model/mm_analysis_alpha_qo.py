...
forceGroupTable = {"Con":11, "Chain":12, "Chi":13, "Excluded":14, "Rama":15, "Direct":16,
                    ...
                    "Water":[16, 18], "Beta":[23, 24, 25], "Pap":26, "DH":27, "Q":1, "Rg":2}
...
forces = [
    q_value(oa, "../../alpha.pdb", Qflag=1, contact_threshold=1.2),
#    con_term(oa),
#    chain_term(oa),
#    chi_term(oa),
...
if args.output is None:
    outFile = os.path.join(os.path.dirname(args.trajectory), "alpha-qo.dat")
else:
    outFile = args.output
