...
# apply forces
forceGroupTable = {"Con":11, "Chain":12, "Chi":13, "Excluded":14, "Rama":15, "Contact":18, "Fragment":19, "beta_1":23, "beta_2":24,"beta_3":25, "Helical":28, "Total":list(range(11, 29)), "Beta":[23, 24, 25], "Pap":26, "DH":27}
...
# showEnergy = ["Q", "Rg", "Con", "Chain", "Chi", "Excluded", "Rama", "Contact", "Fragment", "Membrane", "Beta", "Pap", "DH", "Total"]
...
showEnergy = ["Con", "Chain", "Chi", "Excluded", "Rama", "Contact", "Fragment", "Beta", "Pap", "Helical", "DH", "Total"]
